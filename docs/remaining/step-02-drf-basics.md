...
| Когда | формы без модели, echo, login, «склейка» нескольких моделей | CRUD одной модели (товар, скидка) |
...
| Когда | login, health, confirm-email, «одна операция» | ресурс с полным CRUD (товары, скидки) |
